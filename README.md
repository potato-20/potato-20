...
> Upstream fixes and detections for the tools I rely on day to day — **11 PRs across 8 projects, 2 merged.**
...
| **testssl.sh** | [#3049](https://github.com/testssl/testssl.sh/pull/3049) | Fix `--mx host:port` parsing + no-MX message | open |
